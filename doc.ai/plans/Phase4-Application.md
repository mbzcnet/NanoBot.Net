...
**交付物**:
- `AddNanoBotBackgroundServices` 扩展方法 ✅
...
**完成标准**:
- Docker 构建成功（Docker daemon 未运行，但配置正确）
- .NET 构建验证通过 ✅
...
**交付物**:
- `install/homebrew-nanobot/` 目录 ✅
- `install/homebrew-nanobot/Formula/nanobot.rb` 文件 ✅
